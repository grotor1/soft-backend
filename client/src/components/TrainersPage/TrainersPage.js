            ...
            <div className="trainers">
                <div className="container">
                    ...
                    <div className="trainers__description">
                        <p className="trainers__text">Выберите тренера из предложеных или <a href="https://docs.google.com/forms/d/e/1FAIpQLSewKiUK4hdB3tA7GwreTRDctwxo4Xp_zzr1YDHOH6bguKEYLw/viewform?usp=sf_link" className="green-text">оставьте заявку</a></p>
