...
const Accordion = () => {
    ...
    const data = [
        ...
        },
        {
            ...
            answer: 'Конечно. Занятия проходят с тренером. Он подстроит весь тренировочный процесс под вас. Будут учитываться все аспекты и пожелания.',
        },
        {
        ...
        },
        {
            ...
            answer: 'Да! Многие тренеры на нашей платформе проводят групповые занятия. Чтобы узнать, кто именно, посмотрите на описание тренеров. ',
        },
    ]
    const toggle = (i) => {
        if (itemSelected === i) {
